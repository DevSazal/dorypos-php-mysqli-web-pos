...
<body>
	<div class="main">
		...
		<div id="scanpdt" class="container text-center" style="margin-top:1%">
            ...
            if(isset($_GET['entry'])){
              if(isset($_GET['barcode_'])){
                $barcode0=$_GET['barcode_'];
                $sql0="SELECT * FROM dorypos_product WHERE barcode='{$barcode0}'";
                $result0=mysqli_query($db,$sql0);
                if(mysqli_num_rows($result0)>0){
                    $record0=mysqli_fetch_assoc($result0);
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="name_" value="<?php echo $record0['name']; ?>" class="form-control" id="exampleInputAmount" placeholder="Product Name">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="" class="form-control" id="exampleInputAmount" placeholder="<?php echo $_GET['barcode_'] ?>" value="<?php echo $record0['barcode']; ?>" disabled>
              <?php
            }else {
              ?>
              <div class="input-group-addon">|||| ||</div>
              <input type="text" name="barcode_"  onmouseover="this.focus();" class="form-control" id="exampleInputAmount" placeholder="UPC" >
              <?php
            }
              } else {
                ?>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="cost_price_" value="<?php echo $record0['cost']; ?>" class="form-control" id="exampleInputAmount" placeholder="Cost Price">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              <div class="input-group-addon">BDT</div>
              <input type="text" name="sale_price_" value="<?php echo $record0['price']; ?>" class="form-control" id="exampleInputAmount" placeholder="Sale Price">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="quantity_" value="<?php echo $record0['quantity']; ?>" class="form-control" id="exampleInputAmount" placeholder="Quantity">
            </div>
          </div>
          <div class="form-group">
          ...
          <textarea name="comment_" value="<?php echo $record0['comment']; ?>" class="form-control" rows="3" placeholder="Comment"></textarea>
...
if (isset($_POST['add_product2'])) {
  ...
  elseif(empty($_POST['name_']) || ( empty($_POST['barcode_']) && empty($_GET['barcode_']) ) || $_POST['category_']==NULL  || $_POST['brand_']==NULL )
    {
      ...
      $date = dateinfo();
      $sql = "UPDATE  dorypos_product SET name='$name', barcode='$barcode', cost={$cost_price}, price={$sale_price}, quantity={$quantity}, category_id={$category}, brand_id={$brand}, comment='$comment' WHERE barcode='{$barcode}'";
          ...
          if (mysqli_query($db, $sql)) {
                      ...
                      //location.reload();
                      // header("Location: entry.php?app=".handler()."&token=".token());
                      // exit();
