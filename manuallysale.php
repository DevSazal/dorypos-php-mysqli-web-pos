...
<body>
	<div class="main">
		<div class="container">
			<div class="row">
				<h1 style="text-align:center;color:#FFFFFF "><b>Add To Cart<b></h1>
			</div>
		</div>
		<div class="container">
			<div class="row">
					<div class="col-md-5 col-xm-5  col-sm-5 left-table">
						<form class="" action="" method="post">
								 <h4 style="color: #e74c3c; margin-top: 25px;" class="text-center">*** Enter Product Barcode for Sale</h4>
								 <input   class="email" id="notAutofocus"  type="text" Placeholder="UPC / Barcode" name="barcode_" autocomplete="off" autofocus/>
